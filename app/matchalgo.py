def match(me, other_array):
    others=[]
    user = [[me['country'], me['age'], me['occupation'], me["interests"], me["sports"], me["songs"], me["languages"], me["food"]], [me['gender'], me['ethnicity'], me['class'], me['university']], [me['username'], me['email'], me['name'], me['country'], me['ethnicity'], me['gender']]]
    for x in other_array:
        if x["complete"] == "true":
            temp = [[x['country'], x['age'], x['occupation'], x["interests"], x["sports"], x["songs"], x["languages"], x["food"]], [x['gender'], x['ethnicity'], x['class'], x['university']], [x['username'], x['email'], x['name'], x['country'], x['ethnicity'], x['gender']]]
            others.append(temp)
    rating_array=[]
    for other in others:
        common_interests=[]
